...
@Component({
  selector: 'app-look-at-blended-triangles',
  imports: [],
  host: { class: 'canvas-container' }, // для :host
  templateUrl: '../../index.html',
})
export class LookAtBlendedTriangles {
  ...
  private readonly points = [
    ...
    { coord: { x: 0.0, y: 0.5, z: -0.4 }, color: { r: 0.4, g: 1.0, b: 0.4, a: this.alpha } }, // верх
    { coord: { x: -0.5, y: -0.5, z: -0.4 }, color: { r: 0.4, g: 1.0, b: 0.4, a: this.alpha } }, // лево
    { coord: { x: 0.5, y: -0.5, z: -0.4 }, color: { r: 1.0, g: 0.4, b: 0.4, a: this.alpha } }, // право
    // Жёлтый треугольник в середине
    { coord: { x: 0.5, y: 0.4, z: -0.2 }, color: { r: 1.0, g: 0.4, b: 0.4, a: this.alpha } }, // верх
    { coord: { x: -0.5, y: 0.4, z: -0.2 }, color: { r: 1.0, g: 1.0, b: 0.4, a: this.alpha } }, // лево
    { coord: { x: 0.0, y: -0.6, z: -0.2 }, color: { r: 1.0, g: 1.0, b: 0.4, a: this.alpha } }, // право
    // Ближний синий треугольник
    { coord: { x: 0.0, y: 0.5, z: 0.0 }, color: { r: 0.4, g: 0.4, b: 1.0, a: this.alpha } }, // верх
    { coord: { x: -0.5, y: -0.5, z: 0.0 }, color: { r: 0.4, g: 0.4, b: 1.0, a: this.alpha } }, // лево
    { coord: { x: 0.5, y: -0.5, z: 0.0 }, color: { r: 1.0, g: 0.4, b: 0.4, a: this.alpha } }, // право
  ];
  ...
  constructor() {
    ...
    injectWebGLRender({
      ...
      setup: ({ gl, program, destroyRef }) => {
         ...
         * Результирующий цвет вычисляется по формуле:
         * цвет(rgb) = <исходный цвет> * src_factor + <целевой цвет> * dst_factor
         * src_factor и dst_factor - коэффициенты
         * Варианты:
