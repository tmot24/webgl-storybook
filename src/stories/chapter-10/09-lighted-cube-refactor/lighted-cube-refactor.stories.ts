...
import { LightedCubeRefactor } from './lighted-cube-refactor';

const meta: Meta<LightedCubeRefactor> = {
  title: 'WebGL/Глава 10/09 LightedCubeRefactor',
  component: LightedCubeRefactor,
  argTypes: {
    // color: { control: 'color' },
...
type Story = StoryObj<LightedCubeRefactor>;
